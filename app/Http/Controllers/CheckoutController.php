...
//        if (Session::has('cart') && count(Session::get('cart')) > 0) {
        if ($carts && count($carts) > 0) {
            ...
            return view('n_frontend.shipping_info', compact('categories', 'carts'));
        }
    ...
    public function store_shipping_info(Request $request)
    {
        ...
        return view('n_frontend.delivery_info', compact('carts'));
    ...
    public function store_delivery_info(Request $request)
    {
        ...
        if ($carts && count($carts) > 0) {
            ...
            return view('n_frontend.payment_select', compact('carts', 'shipping_info', 'total'));
...
//            if(Auth::user()->club_point->points >= $point) {
    ...
    public function order_confirmed()
    {
        ...
        return view('n_frontend.order_confirmed', compact('order'));
    }
}
