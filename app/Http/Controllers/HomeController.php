...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        /*$data['sideNav_categories'] = Category::where('parent_id',0)->limit(8)->get();

        $home_categories = BusinessSetting::where('type','home_categories')->first();
        $categories = json_decode($home_categories->value);
        $data['products'] = Product::orderBy('id','DESC')->get();
        $data['home_categories'] = Category::where('parent_id',0)->whereIn('id',$categories)->limit(8)->get();
        $data['categories'] = Category::where('parent_id',0)->get();*/
        return view('n_frontend.index');
    }
    ...
    public function login()
    {
        ...
        return view('n_frontend.auth.login');
    }
    ...
    public function registration(Request $request)
    {
        ...
        return view('n_frontend.auth.registration');
    }
    ...
    public function dashboard()
    {
        ...
        elseif(Auth::user()->user_type == 'customer'){
            ...
            return view('n_frontend.user.dashboard');
        }
    ...
    public function customer_address_update(Request $request)
    {
        ...
        $address->address       = $request->house_address;
        $address->city          = $request->city;
        $address->postal_code   = $request->postal_code;
        $address->phone         = $request->phone;
        $previousDefault = Address::where([
            ['user_id', Auth::user()->id],
            ['set_default', 1],
            ['id', '!=', $address->id]
        ])->first();
        if ($request->is_default == 1) {
            if (!empty($previousDefault)) {
                $previousDefault->update(['set_default'=>0]);
            }
            $address->set_default = $request->is_default;
        } else {
            if (empty($previousDefault)) {
                flash(translate('At least one address need to be set as default'))->error();
                return back();
            }
        }
        $address->save();
    ...
    public function load_home_categories_section(){
        ...
        return view('n_frontend.product.product__tab');
    }
    ...
    public function trackOrder(Request $request)
    {
        if($request->has('order_code')){
            ...
            if($order != null){
                return view('n_frontend.track_order', compact('order'));
            }
        }
        return view('n_frontend.track_order');
    }

    public function product(Request $request, $slug)
    {
        $detailedProduct  = Product::with('category')->where('slug', $slug)->where('approved', 1)->first();
        ...
        if($detailedProduct != null && $detailedProduct->published){
            ...
            if($detailedProduct->digital == 1){
                return view('n_frontend.digital_product_details', compact('detailedProduct'));
            }
            else {
                return view('n_frontend.product_details', compact('detailedProduct'));
            }
...
//        $categories = Category::where('level', 0)->orderBy('name', 'asc')->get();
        ...
        return view('n_frontend.all_category', compact('categories'));
    }
...
//        $products = filter_products(Product::where('published', 1)->where('name', 'like', '%'.$request->search.'%'))->orWhere('tags', 'like', '%'.$request->search.'%')->get()->take(3);
        ...
        if(sizeof($keywords)>0 || sizeof($categories)>0 || sizeof($products)>0 || sizeof($shops) >0){
            return view('n_frontend.search_content', compact('products', 'categories', 'keywords', 'shops'));
        }
        return '0';
    }
...
//                $str = '"'.$request->color.'"';
//                $products = $products->where('colors', $str);
//                $selected_color = $request->color;
//            }
//        }
        $products = $products->paginate(12);

        return view('n_frontend.product_listing', compact('products', 'page_title', 'min_price', 'max_price', 'sort_by', 'category_slug','is_featured'));
    }
    ...
    public function search(Request $request, $category_id = null, $brand_id = null)
    {
        ...
        return view('n_frontend.product_listing', compact('products', 'query', 'category_id', 'brand_id', 'sort_by', 'seller_id','min_price', 'max_price', 'attributes', 'selected_attributes', 'all_colors', 'selected_color'));
    }
...
//        }
    ...
    public function sellerpolicy(){
        return view("n_frontend.policies.sellerpolicy");
    }

    public function returnpolicy(){
        return view("n_frontend.policies.returnpolicy");
    }
    ...
    public function terms(){
        return view("n_frontend.policies.terms");
    }

    public function privacypolicy(){
        return view("n_frontend.policies.privacypolicy");
    }
    ...
    public function get_category_items(Request $request){
        ...
        return view('n_frontend.partials.category_elements', compact('category'));
    }
