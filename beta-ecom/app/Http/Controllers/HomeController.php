...
//        $products = filter_products(Product::where('published', 1)->where('name', 'like', '%'.$request->search.'%'))->orWhere('tags', 'like', '%'.$request->search.'%')->get()->take(3);
    ...
    public function all_products(Request $request)
    {
        ...
        $category_id = $request->caregory_id;
...
//        }
        ...
        return view('n_frontend.product_listing', compact('products','min_price', 'max_price', 'sort_by', 'category_id','is_featured'));
    }
...
//        }
    ...
    public function contact() {
        return view('n_frontend.contact.contact');
    }
}
