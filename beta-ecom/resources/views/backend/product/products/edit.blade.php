            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="brand">
                            <label class="col-md-3 col-from-label">{{translate('Origin Of Product')}} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="product_origin" id="product_origin" data-live-search="true">
                                    <option value="">{{ translate('Select Origin') }}</option>
                                    @foreach (\App\Country::all() as $country)
                                    <option {{$product->product_origin == $country->id ? 'selected':''}} value="{{ $country->id }}">{{ $country->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
