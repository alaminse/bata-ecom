...
<div class="ltn__call-to-action-area section-bg-1 bg-image pt-120 pb-120" data-bs-bg="{{ asset('public/frontend/img/bg/27.jpg') }}">
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-4">
                <!-- <img src="{{ asset('public/frontend/img/banner/15.png') }}" alt="#"> -->
            </div>
