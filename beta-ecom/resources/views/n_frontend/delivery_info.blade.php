                ...
                <form class="form-default" action="{{ route('checkout.store_delivery_info') }}" role="form" method="POST">
                    ...
                    <div class="card mb-3 shadow-sm border-0 rounded">
                        ...
                        <div class="card-footer justify-content-end">
                            {{-- <button type="submit" class="">{{ translate('Continue to Delivery Info')}}</button> --}}
                            <button type="submit" name="owner_id" value="{{ App\User::where('user_type', 'admin')->first()->id }}" class="theme-btn-1 btn btn-effect-1">{{ translate('Continue to Payment')}}</button>
                        </div>
                    </div>
                </form>
                @endif
