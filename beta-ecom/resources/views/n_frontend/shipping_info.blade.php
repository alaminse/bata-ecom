                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="input-item">
                                <select class="nice-select" data-live-search="true" name="country" required>
                                    <option value="">Select Country</option>
                                    @foreach (\App\Country::where('status', 1)->get() as $key => $country)
                                        <option style="position: absolute;" value="{{ $country->name }}">{{ $country->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="input-item">   
                                <select class="aiz-selectpicker" data-live-search="true" name="city" required>
