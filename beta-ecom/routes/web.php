...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::group(['prefix' => 'bulk-upload/download'], function() {
        ...
        Route::get('/country', 'ProductBulkUploadController@pdf_download_country')->name('pdf.download_country');
...
// Route::get('/latest/blog', 'BlogController@latest_blog')->name('latest.blog');
Route::get('/blog/{slug}', 'BlogController@blog_details')->name('blog.details');
Route::post('/blog/comment/{id}', 'BlogController@blog_comment')->name('blog.comment');
...
// single product 
 ...
 Route::get('/single/product', 'ProductController@single_product')->name('single.product');
 Route::get('/all/products', 'HomeController@all_products')->name('all.products');
 Route::post('/customer/address/update', 'HomeController@customer_address_update')->name('customer.address.update');
