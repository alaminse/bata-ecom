        ...
        <div class="aiz-side-nav-wrap">
            ...
            <!-- Sellers -->
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('22', json_decode(Auth::user()->staff->role->permissions)))
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('testimonials.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['testimonials.index, testimonials.create, testimonials.edit'])}}">
                            <i class="las la-folder-open aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ __('Testimonials') }}</span>
                        </a>
                    </li>
                @endif
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('22', json_decode(Auth::user()->staff->role->permissions)))
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('contact.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['contact.index'])}}">
                            <i class="las la-folder-open aiz-side-nav-icon"></i>
                            <span class="aiz-side-nav-text">{{ __('Messages') }}</span>
                        </a>
                    </li>
                @endif
