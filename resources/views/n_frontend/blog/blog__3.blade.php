        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title-area ltn__section-title-2--- text-center">
                    ...
                    <h1 class="section-title">{{ translate('Latest News Feeds') }}</h1>
                </div>
            </div>
        </div>
                        ...
                        <div class="ltn__blog-meta">
                            <ul>
                                <li class="ltn__blog-author">
                                    <a href="javascript:void(0)"><i class="far fa-user"></i>by: {{ env('APP_NAME')}}</a>
                                </li>
                                <li class="ltn__blog-tags">
                                    <a href="{{ route('blog', ['category'=>$blog->category->id]) }}"><i class="fas fa-tags"></i>{{ $blog->category->category_name }}</a>
                                </li>
                            </ul>
                        </div>
